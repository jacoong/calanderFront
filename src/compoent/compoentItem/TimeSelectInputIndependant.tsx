...
const TimeSelectInputIndependant: React.FC<CustomSelectorProps> = ({  initialTime,type,handleEndEventTime,handleStartEventTime}) => {
  ...
  const formatTime = (time: string) => {
    ...
    return (
        ...
        selectedItem={`${timeLabels.indexOf(selectedTime) + 1}`}
...
export default TimeSelectInputIndependant;